...
import 'package:flutter_application_1/services/Approver_Api/Circular_Approver_update_api.dart';
...
class Circularapprovaledit extends StatefulWidget {
  final int Id;
  final Function fetchcircular;
  const Circularapprovaledit(
      {super.key, required this.Id, required this.fetchcircular});

  @override
  State<Circularapprovaledit> createState() => _CircularapprovaleditState();
}

class _CircularapprovaleditState extends State<Circularapprovaledit> {
...
//update circular.......
  Future<void> _updateCircular(String status, BuildContext context) async {
    ...
    CircularUpdateApproverModel updateapprover = CircularUpdateApproverModel(
      id: widget.Id,
    ...
    print("ID: ${updateapprover.id}");
    print("Roll Number: ${updateapprover.rollNumber}");
    print("User Type: ${updateapprover.userType}");
    print("Headline: ${updateapprover.headLine}");
    print("Circular: ${updateapprover.circular}");
    print("File Type: ${updateapprover.fileType}");
    print("File Path: ${updateapprover.link}");
    print("Status: ${updateapprover.status}");

    print("Schedule On: ${updateapprover.scheduleOn}");
    print("Updated On: ${updateapprover.updatedOn}");
    print("Recipient: ${updateapprover.recipient}");
    print("Grade IDs: ${updateapprover.gradeIds}");

    await circularapproverupdate(updateapprover, context, widget.fetchcircular);
