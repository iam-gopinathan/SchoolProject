...
class _CreateFeedbackState extends State<CreateFeedback> {
  ...
  List<String> dropdownItems = ['Students', 'Teachers'];
  String? selectedRecipient = 'Students';
  ...
  Future<void> submitFeedback(String status) async {
    ...
    if (selectedGradeId != 'everyone' &&
      ...
      _showSnackBar('Please select a section for the selected grade!');
      setState(() {
        isLoading = false;
        isPublishing = false;
      });
    ...
    //
    print('gradeeee ${selectedGradeId}');
    //
    CreateFeedbackModel create = CreateFeedbackModel(
      userType: UserSession().userType ?? '',
      rollNumber: UserSession().rollNumber ?? '',
      recipient: 'Students',
      gradeId: selectedGradeId == 'everyone' ? '0' : selectedGradeId ?? '',
