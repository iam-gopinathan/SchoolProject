...
class Editnewsdraft extends StatefulWidget {
  const Editnewsdraft({super.key});

  @override
  State<Editnewsdraft> createState() => _EditnewsdraftState();
}

class _EditnewsdraftState extends State<Editnewsdraft> {
